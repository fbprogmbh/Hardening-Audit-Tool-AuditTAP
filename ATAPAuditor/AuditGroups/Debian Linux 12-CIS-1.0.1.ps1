...
[AuditTest] @{
    ...
    Test = {
        ...
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.1.1.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.1.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.1.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.1.4.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.1.5.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.1.6.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.1.7.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.1.8.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.2.1.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.2.1.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.2.2.1.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.2.2.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.2.2.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.2.2.4.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.2.3.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.2.3.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.2.4.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.2.4.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.2.5.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.2.5.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.2.5.4.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.2.6.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.2.6.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.2.6.4.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.2.7.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.2.7.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.1.2.7.4.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.3.1.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.3.1.4.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.4.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.5.1.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.5.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.5.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.6.1.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.6.4.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $path = $parentPath+"/Helpers/ShellScripts/Debian_12/1.8.2.sh"
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $path = $parentPath+"/Helpers/ShellScripts/Debian_12/1.8.3.sh"
        $result=bash $path | grep " PASS "
        if($result -ne $null){
            return $retCompliant
        }
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $path = $parentPath+"/Helpers/ShellScripts/Debian_12/1.8.4.sh"
        $result=bash $path | grep " PASS "
        if($result -ne $null){
            return $retCompliant
        }
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $path = $parentPath+"/Helpers/ShellScripts/Debian_12/1.8.5.sh"
        $result=bash $path | grep " PASS "
        if($result -ne $null){
            return $retCompliant
        }
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $path = $parentPath+"/Helpers/ShellScripts/Debian_12/1.8.6.sh"
        $result=bash $path | grep " PASS "
        if($result -ne $null){
            return $retCompliant
        }
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $path = $parentPath+"/Helpers/ShellScripts/Debian_12/1.8.7.sh"
        $result=bash $path | grep " PASS "
        if($result -ne $null){
            return $retCompliant
        }
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $path = $parentPath+"/Helpers/ShellScripts/Debian_12/1.8.8.sh"
        $result=bash $path
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $path = $parentPath+"/Helpers/ShellScripts/Debian_12/1.8.9.sh"
        $result=bash $path
        if($result -match " PASS "){
            return $retCompliant
        }
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/1.7.10.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/2.1.13.sh"
        $result = bash $script
        if ($?){
            return $retCompliant
        }
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $path = $parentPath+"/Helpers/ShellScripts/Debian_12/2.1.1.1.sh"
        $result=bash $path
        if($result -match "PASS:"){
            return $retCompliant
        }
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/2.3.3.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/2.4.1.8.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/2.4.2.1.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $path = $parentPath+"/Helpers/ShellScripts/Debian_12/3.1.1.sh"
        $result=bash $path
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/3.1.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/3.2.1.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/3.2.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/3.2.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/3.2.4.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/3.3.1.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/3.3.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/3.3.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/3.3.4.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/3.3.5.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/3.3.6.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/3.3.7.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/3.3.8.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/3.3.9.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/3.3.10.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/3.3.11.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        ...
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $path = $parentPath+"/Helpers/ShellScripts/Debian_12/3.5.1.6.sh"
        $result=bash $path
        if($result -eq $null){
            return $retCompliant
        }
...
[AuditTest] @{
    ...
    Test = {
        ...
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $path1 = $parentPath+"/Helpers/ShellScripts/Debian_12/3.5.2.10_1.sh"
        $path2 = $parentPath+"/Helpers/ShellScripts/Debian_12/3.5.2.10_2.sh"
        $path3 = $parentPath+"/Helpers/ShellScripts/Debian_12/3.5.2.10_3.sh"
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.1.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.1.6.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.1.7.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.1.8.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.1.9.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.1.10.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.1.11.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.1.12.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.1.13.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.1.14.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.1.15.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.1.16.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.1.17.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.1.18.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.1.19.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.1.20.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.1.21.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.1.22.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.2.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.2.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.2.6.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.2.7.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.3.2.1.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.3.2.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.3.2.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.3.2.4.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.3.3.1.1.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.3.3.1.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.3.3.1.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.3.3.2.1.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.3.3.2.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.3.3.2.4.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.3.3.2.5.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.3.3.2.6.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.3.3.2.7.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.3.3.2.8.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.3.3.3.1.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.3.3.3.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.3.3.3.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.3.3.4.1.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.3.3.4.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.3.3.4.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.3.3.4.4.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.4.1.1.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.4.1.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.4.1.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.4.1.4.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.4.1.5.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $path = $parentPath+"/Helpers/ShellScripts/Debian_12/5.5.1.5.sh"
        $result=bash $path
        if($result -eq $null){
            return $retCompliant
        }
...
[AuditTest] @{
 ...
 [AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.4.2.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.4.2.4.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $path = $parentPath+"/Helpers/ShellScripts/Debian_12/6.2.9.sh"
        $result=bash $path
        if($result -eq $null){
            return $retCompliant
        }
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.4.2.6.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.4.2.7.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {            
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.4.2.8.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        }
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.4.3.1.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.4.3.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/5.4.3.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.2.1.1.4.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.2.1.1.5.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.2.1.1.6.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.2.1.2.4.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.1.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.1.4.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.2.1.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.2.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.3.1.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.3.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.3.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.3.4.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.3.5.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.3.6.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.3.7.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.3.8.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.3.9.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.3.10.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $path1 = $parentPath+"/Helpers/ShellScripts/Debian_12/4.1.3.11_1.sh"
        ...
        $path2 = $parentPath+"/Helpers/ShellScripts/Debian_12/4.1.3.11_2.sh"
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.3.12.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.3.13.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.3.14.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.3.15.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.3.16.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.3.17.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.3.18.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.3.19.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.4.1.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.4.2.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    Id = "6.3.4.3"
    Task = "Ensure aonly authorized groups are assigned ownership of audit log files"
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.4.3.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    Id = "6.3.4.4"
    Task = "Ensure the audit log directory mode is configured"
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.4.4.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.4.5.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.4.6.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.4.7.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.4.8.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/6.3.4.9.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/7.1.9.sh"
        $result = bash $script
        if ($?) {
            return $retCompliant
        } else {
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $script = Join-Path -Path $parentPath -ChildPath "Helpers/ShellScripts/Debian_12/7.1.10.sh"
        $result = bash $script
        if($?){
            return $retCompliant
        }
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $path = $parentPath+"/Helpers/ShellScripts/Debian_12/6.2.3.sh"
        $result=bash $path
        if($result -match $null){
            return $retCompliant
        }
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $path = $parentPath+"/Helpers/ShellScripts/Debian_12/6.2.5.sh"
        $result=bash $path
        if($result -eq $null){
            return $retCompliant
        }
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $path = $parentPath+"/Helpers/ShellScripts/Debian_12/6.2.6.sh"
        $result=bash $path
        if($result -eq $null){
            return $retCompliant
        }
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $path = $parentPath+"/Helpers/ShellScripts/Debian_12/6.2.7.sh"
        $result=bash $path
        if($result -eq $null){
            return $retCompliant
        }
...
[AuditTest] @{
    ...
    Test = {
        $parentPath = Split-Path -Parent -Path $PSScriptRoot
        $path = $parentPath+"/Helpers/ShellScripts/Debian_12/6.2.8.sh"
        $result=bash $path
        if($result -eq $null){
            return $retCompliant
        }
